...
<?php if ($total_cost > 0): ?>
						<p><?php printf('Please mail your check for <strong>$%1$d</strong> (made out to <em>%2$s</em> and postmarked no later than <em>%3$s</em>), along with your name and email address, to:', $dancer->get_price_total(), esc_html($options['payable_to']), $dancer->get_date_mail_postmark_by($options['postmark_within'], 'F jS')); ?></p>
